...
import com.example.mlkitintegration.R;
...
public class GraphicOverlay extends View {
    ...
    // Métodos para definir propriedades do overlay, como largura da linha e cor
    private void setStrokeWidth(int width) {
        // Implemente a lógica para definir a largura da linha do overlay
    }

    private void setStrokeColor(int color) {
        // Implemente a lógica para definir a cor da linha do overlay
    }
